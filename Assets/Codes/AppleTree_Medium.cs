...
public class AppleTree_Medium : MonoBehaviour
{
    [Header("Inscribed")]
    public GameObject bombPrefab;
    public GameObject applePrefab;
    public GameObject coinPrefab;
    public float speed = 30f; //I am speed!
    public float leftAndRightEdge = 24f;
    public float appleDropDelay = 0.75f;
    public float bombDropDelay = 1.25f; // add a delay for dropping bombs
    ...
    private double BombRandom = 0.67f;
